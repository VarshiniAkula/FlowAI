...
const features = [
  ...
  {
    icon: Zap,
    title: 'Real AI, or free demo',
    description:
      'Bring your own Gemini key, or use the limited FlowMind Groq demo — with a deterministic simulation fallback so it always runs.',
  },
];
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-secondary px-4 py-1.5 text-xs font-semibold text-primary">
              ...
              Live · real AI (Groq demo / Gemini BYOK) + semantic knowledge search
            </div>
